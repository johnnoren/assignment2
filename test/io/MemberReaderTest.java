...
class MemberReaderTest {
	...
	void read() {
		...
		listWithMembers.add(new Member(new IdentityNumber(7502031234L), new Name("Anna Andersson"), LocalDate.parse("2022-05" +
				"-03")));
		listWithMembers.add(new Member(new IdentityNumber(8505132345L), new Name("Per Persson"),
